...
| [Backend](docs/SYSTEM_ARCHITECTURE.md#4-arquitetura-do-backend) | API, endpoints e estrutura do backend |
| [Frontend](docs/SYSTEM_ARCHITECTURE.md#3-arquitetura-do-frontend) | Componentes e estrutura do frontend |
